...
namespace sf
{
    ...
    public:
        ...
        public:
            ...
            // causes a crash.
            //////////////////////////////////////////////////////////////////////
            void setCharacter(std::size_t pos, unsigned int character);
            ...
            // causes a crash.
            //////////////////////////////////////////////////////////////////////
            unsigned int getCharacterStyle(std::size_t pos) const;
            ...
            // causes a crash
            //////////////////////////////////////////////////////////////////////
            unsigned int getCharacter(std::size_t pos) const;
        ...
        // Attempting to access a character outside of the bounds causes a crash.
        //////////////////////////////////////////////////////////////////////////
        void setCharacter(std::size_t line, std::size_t pos, unsigned int character);
        ...
        // Attempting to access a character outside of the bounds causes a crash.
        //////////////////////////////////////////////////////////////////////////
        unsigned int getCharacterStyle(std::size_t line, std::size_t pos) const;

        //////////////////////////////////////////////////////////////////////////
        // Get a character
        // Attempting to access a character outside of the bounds causes a crash.
        //////////////////////////////////////////////////////////////////////////
        unsigned int getCharacter(std::size_t line, std::size_t pos) const;
    ...
    private:
        ...
        //////////////////////////////////////////////////////////////////////////
        sf::Text createText(const sf::String& string, const sf::Font& font) const;
        ...
        sf::Color m_defaultOutlineColor{ sf::Color::Transparent };
        float m_defaultOutlineThickness{ 0.f };
